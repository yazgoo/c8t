...
(function($opal) {
  ...
  $opal.add_stubs(['$is_a?', '$each', '$parse_line', '$gsub', '$include?', '$split', '$assemble', '$collect!', '$=~', '$to_i', '$[]', '$sprintf', '$<<', '$p', '$>', '$size', '$==', '$[]=', '$upcase', '$join', '$first', '$compact', '$map', '$match', '$keys', '$to_a', '$+']);
  return (function($base, $super) {
    function $Assembler(){};
    var self = $Assembler = $klass($base, $super, 'Assembler', $Assembler);

    var def = $Assembler._proto, $scope = $Assembler._scope;
    def.binary = def.result = def.labels = def.address = def.instructions = nil;
    def.$initialize = function() {
      ...
      self.result = [];
      self.binary = [];
      return self.instructions = $hash(/CLS/, "00E0", /RET/, "00EE", /SYS (\w+)/, "0%3x", /JP (\w+)/, "1%3x", /CALL (\w+)/, "2%3x", /SE V(\d+), (\d+)/, "3%1x%02x", /SNE V(\d+), (\d+)/, "4%1x%02x", /SE V(\d+), V(\d+)/, "5%1x%1x0", /LD V(\d+), (\d+)/, "6%1x%02x", /ADD V(\d+), (\d+)/, "7%1x%02x", /LD V(\d+), V(\d+)/, "8%1x%1x0", /OR V(\d+), V(\d+)/, "8%1x%1x1", /AND V(\d+), V(\d+)/, "8%1x%1x2", /XOR V(\d+), V(\d+)/, "8%1x%1x3", /ADD V(\d+), V(\d+)/, "8%1x%1x4", /SUB V(\d+), V(\d+)/, "8%1x%1x5", /SHR V(\d+) {, V(\d+)}/, "8%1x%1x6", /SUBN V(\d+), V(\d+)/, "8%1x%1x7", /SHL V(\d+) {, V(\d+)}/, "8%1x%1xE", /SNE V(\d+), V(\d+)/, "9%1x%1x0", /LD I, (\w+)/, "A%03x", /JP V0, (\w+)/, "B%03x", /RND V(\d+), (\d+)/, "C%1x%02x", /DRW V(\d+), V(\d+), (\d+)/, "D%1x%1x%1x", /SKP V(\d+)/, "E%1x9E", /SKNP V(\d+)/, "E%1xA1", /LD V(\d+), DT/, "F%1x07", /LD V(\d+), K/, "F%1x0A", /LD DT, V(\d+)/, "F%1x15", /LD ST, V(\d+)/, "F%1x18", /ADD I, V(\d+)/, "F%1x1E", /LD F, V(\d+)/, "F%1x29", /LD B, V(\d+)/, "F%1x33", /LD [I], V(\d+)/, "F%1x55", /LD V(\d+), [I]/, "F%1x65");
    };

    def.$parse = function(data) {
      var $a, $b, TMP_1, $c, TMP_2, self = this;
      if (($a = data['$is_a?']((($b = $scope.Array) == null ? $opal.cm('Array') : $b))) !== false && $a !== nil) {
        ($a = ($b = data).$each, $a._p = (TMP_1 = function(line){var self = TMP_1._s || this;if (line == null) line = nil;
        return self.$parse_line(line)}, TMP_1._s = self, TMP_1), $a).call($b)
        } else {
        data = data.$gsub("\\n", "\n");
        if (($a = data['$include?']("\n")) !== false && $a !== nil) {
          ($a = ($c = data.$split("\n")).$each, $a._p = (TMP_2 = function(line){var self = TMP_2._s || this;if (line == null) line = nil;
          return self.$parse_line(line)}, TMP_2._s = self, TMP_2), $a).call($c)};
      };
      return self;
    };
    ...
    def.$assemble = function() {
      var $a, $b, TMP_3, self = this;
      return ($a = ($b = self.result).$each, $a._p = (TMP_3 = function(instruction, parameters){var self = TMP_3._s || this, $a, $b, TMP_4, str = nil;
        if (self.binary == null) self.binary = nil;
if (instruction == null) instruction = nil;if (parameters == null) parameters = nil;
      ($a = ($b = parameters)['$collect!'], $a._p = (TMP_4 = function(p){var self = TMP_4._s || this, $a, $b, $c;
...
if (p == null) p = nil;
        ...
        return self.binary['$<<'](str['$[]']($range(0, 1, false)).$to_i(16))['$<<'](str['$[]']($range(2, 3, false)).$to_i(16));}, TMP_3._s = self, TMP_3), $a).call($b);
    };

    return (def.$parse_line = function(line) {
      var $a, $b, TMP_5, $c, TMP_6, self = this, r = nil;
      self.$p(line);
      line = line.$split(" ");
      if (line.$size()['$>'](0)) {
        if (line['$[]'](0)['$[]'](0)['$=='](";")) {
        ...
        if (line['$[]'](0)['$[]']($range(-1, -1, false))['$=='](":")) {
          ...
          return nil;};
        line = ($a = ($b = line)['$collect!'], $a._p = (TMP_5 = function(i){var self = TMP_5._s || this;if (i == null) i = nil;
        return i.$upcase()}, TMP_5._s = self, TMP_5), $a).call($b).$join(" ");
        r = ($a = ($c = self.instructions.$keys()).$map, $a._p = (TMP_6 = function(re){var self = TMP_6._s || this, $a;if (re == null) re = nil;
        if (($a = line.$match(re)) !== false && $a !== nil) {
            return re
            } else {
            return nil
          }}, TMP_6._s = self, TMP_6), $a).call($c).$compact().$first();
...
(function($opal) {
  ...
  $opal.add_stubs(['$print', '$+', '$[]', '$*', '$==', '$read_nonblock', '$to_i', '$getc', '$include', '$/', '$new', '$map', '$zip', '$update', '$draw_box_s', '$attr_accessor', '$each', '$is_a?', '$index', '$key', '$eq', '$eq=', '$block', '$nil?', '$size', '$sleep', '$unqueue', '$on_unblock', '$call', '$const_get', '$collect', '$-', '$to_proc', '$chars', '$concat', '$ready', '$pause', '$run', '$pause=', '$run_multiple', '$run_instruction', '$>', '$now', '$beep', '$f00', '$get_current_key', '$[]=', '$&', '$>>', '$each_with_index', '$%', '$push', '$^', '$write', '$delete_at', '$product', '$to_a', '$pop', '$===', '$send', '$include?', '$rand', '$draw', '$key_pressed', '$instance_variable_set', '$split', '$sprintf']);
  (function($base, $super) {
    function $Terminal(){};
...
if (a == null) a = nil;
      ...
      return self.screen.$draw_box_s(u['$[]'](0), u['$[]'](1), [c['$*'](255), c['$*'](255), c['$*'](255)]).$update();
    };
    ...
    return (def.$get_current_key = function(block, on_unblock) {
      ...
      if (($a = ($b = block, ($b === nil || $b === false))) !== false && $a !== nil) {
        self.ready = true;
        return self.$unqueue(block);
      } else if ((($a = $scope.ENV) == null ? $opal.cm('ENV') : $a).$size()['$=='](0)) {
        $opal.a = self;
        return setTimeout(function() { $opal.a.$unqueue($opal.a) }, 20);
        } else {
        self.$sleep(0.02);
  ...
  return (function($base, $super) {
    ...
    def.mem = def.pc = def.t = def.DT = def.ST = def.out = def.v = def['in'] = def.i = def.I = def.width = def.height = def.stack = nil;
    def.$initialize = function(str, ui) {
      var $a, $b, TMP_5, $c, $d, TMP_6, $e, self = this;
      self.video = self['in'] = self.out = (($a = $scope.Object) == null ? $opal.cm('Object') : $a).$const_get(ui).$new(self.width = 64, self.height = 32);
    ...
    self.$attr_accessor("ready", "pause");
    ...
    def.$run_multiple = function(b) {
      ...
      if ((($a = $scope.ENV) == null ? $opal.cm('ENV') : $a).$size()['$=='](0)) {
        $opal.b = b;};
      if (($a = ($b = b.$ready(), $b !== false && $b !== nil ?($c = b.$pause(), ($c === nil || $c === false)) : $b)) !== false && $a !== nil) {
        b.$run()};
      if ((($a = $scope.ENV) == null ? $opal.cm('ENV') : $a).$size()['$=='](0)) {
        b['$pause='](document.getElementById('pause').checked);
        return setTimeout(function() {b.$run_multiple($opal.b)}, 20);
        } else {
        self.$sleep(0.02);
    ...
    def.$key_pressed = function(mode, char$) {
      var $a, $b, $c, $d, self = this, test = nil;
      if (char$ == null) {
        char$ = self['in'].$get_current_key()
      }
      test = (((($a = char$['$nil?']()) !== false && $a !== nil) ? $a : ($b = char$.$to_i()['$=='](self.v['$[]'](self.$f00())), ($b === nil || $b === false))));
    ...
    def.$draw = function() {
      ...
      return ($a = ($b = ($range(0, 7, false))).$each, $a._p = (TMP_8 = function(dx){var self = TMP_8._s || this, $a, $b, $c, xy = nil;
...
if (dx == null) dx = nil;
    ...
    return (def.$run_instruction = function(i) {
      var $a, $b, TMP_9, $c, TMP_10, $d, TMP_11, $e, TMP_12, $f, TMP_13, self = this, f000 = nil, f00 = nil, f0 = nil, f = nil, ff = nil, fff = nil, $case = nil, a = nil;
      ...
      if (i['$=='](0)) {
        return nil};
      if (i['$=='](224)) {
        ($a = ($b = ($range(0, self.width['$-'](1), false)).$to_a()).$product, $a._p = (TMP_9 = function(xy){var self = TMP_9._s || this;
          if (self.out == null) self.out = nil;
if (xy == null) xy = nil;
        return self.out.$write(xy, 0)}, TMP_9._s = self, TMP_9), $a).call($b, ($range(0, self.height['$-'](1), false)).$to_a());
        self.video = $hash2([], {});};
      if (i['$=='](238)) {
        self.pc = self.stack.$pop()};
      $case = f000;if ((8)['$===']($case)) {$case = f;if ((0)['$===']($case)) {self.v['$[]='](f00, self.v['$[]'](f0))}else if ((1)['$===']($case) || (2)['$===']($case) || (3)['$===']($case)) {self.v['$[]='](f00, self.v['$[]'](f00).$send(["|", "&", "^"]['$[]'](f['$-'](1)), self.v['$[]'](f0)))}else if ((4)['$===']($case)) {a = (self.v['$[]'](f0)['$+'](self.v['$[]'](f00)));
      ...
      self.pc = fff;
      return false;}else if ((3)['$===']($case) || (4)['$===']($case) || (5)['$===']($case) || (9)['$===']($case)) {if (($a = self.v['$[]'](f00).$send((function() {if (($c = [3, 5]['$include?'](f000)) !== false && $c !== nil) {
        return "="
        } else {
        return "!"
      }; return nil; })()['$+']("="), (function() {if (($c = [3, 4]['$include?'](f000)) !== false && $c !== nil) {
        return ff
        } else {
        return self.v['$[]'](f0)
      }; return nil; })())) !== false && $a !== nil) {
        self.pc = self.pc['$+'](2)}}else if ((6)['$===']($case) || (7)['$===']($case)) {if (f000['$=='](6)) {
        self.v['$[]='](f00, ff)
        } else {
        ($a = f00, $c = self.v, $c['$[]=']($a, $c['$[]']($a)['$+'](ff)))
      }}else if ((11)['$===']($case)) {self.pc = fff['$+'](self.v['$[]'](0));
      return false;}else if ((12)['$===']($case)) {self.v['$[]='](f00, self.$rand($range(0, 255, false))['$&'](ff))}else if ((10)['$===']($case)) {self.I = fff}else if ((13)['$===']($case)) {self.$draw()}else if ((14)['$===']($case)) {if (($a = [161, 158]['$include?'](ff)) !== false && $a !== nil) {
        self.$key_pressed(ff['$=='](158))}}else if ((15)['$===']($case)) {$case = ff;if ((30)['$===']($case)) {self.I = self.I['$+'](self.v['$[]'](f00))}else if ((10)['$===']($case)) {self.ready = false;
      self['in'].$get_current_key(true, ($a = ($c = (($d = $scope.Proc) == null ? $opal.cm('Proc') : $d)).$new, $a._p = (TMP_10 = function(e){var self = TMP_10._s || this;
        if (self.v == null) self.v = nil;
if (e == null) e = nil;
      self.v['$[]='](f00, e);
        return self.ready = true;}, TMP_10._s = self, TMP_10), $a).call($c));}else if ((21)['$===']($case) || (24)['$===']($case)) {self.$instance_variable_set("@" + ((function() {if (ff['$=='](24)) {
        return "S"
        } else {
        return "D"
      }; return nil; })()) + "T", self.v['$[]'](f00))}else if ((41)['$===']($case)) {self.I = self.v['$[]'](f00)['$*'](5)}else if ((7)['$===']($case)) {self.v['$[]='](f00, self.DT)}else if ((51)['$===']($case)) {($a = ($d = self.$sprintf("%03d", self.v['$[]'](f00)).$split("")).$each_with_index, $a._p = (TMP_11 = function(v, x){var self = TMP_11._s || this;
        if (self.mem == null) self.mem = nil;
        if (self.I == null) self.I = nil;
if (v == null) v = nil;if (x == null) x = nil;
      return self.mem['$[]='](self.I['$+'](x), v)}, TMP_11._s = self, TMP_11), $a).call($d)}else if ((85)['$===']($case)) {($a = ($e = ($range(0, f00, false))).$each, $a._p = (TMP_12 = function(x){var self = TMP_12._s || this;
        if (self.mem == null) self.mem = nil;
        if (self.I == null) self.I = nil;
        if (self.v == null) self.v = nil;
if (x == null) x = nil;
      return self.mem['$[]='](x['$+'](self.I), self.v['$[]'](x))}, TMP_12._s = self, TMP_12), $a).call($e)}else if ((101)['$===']($case)) {($a = ($f = ($range(0, f00, false))).$each, $a._p = (TMP_13 = function(x){var self = TMP_13._s || this;
        if (self.v == null) self.v = nil;
        if (self.mem == null) self.mem = nil;
        if (self.I == null) self.I = nil;
if (x == null) x = nil;
      return self.v['$[]='](x, self.mem['$[]'](x['$+'](self.I)).$to_i())}, TMP_13._s = self, TMP_13), $a).call($f)}};
      return true;
    }, nil);
  })(self, null);
})(Opal);
...
/* Generated by Opal 0.5.5 */
(function($opal) {
  var $a, self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, assembly = nil, e = nil;
  $opal.add_stubs(['$output', '$parse', '$new', '$run_multiple']);
  ;
  ;
  ;
  assembly = (($a = $scope.Assembler) == null ? $opal.cm('Assembler') : $a).$new().$parse(text = document.getElementById("editor").value).$output();
  e = (($a = $scope.Emulator) == null ? $opal.cm('Emulator') : $a).$new(assembly, "Window");
  return e.$run_multiple();
})(Opal);
