...
if (y == null) y = nil;
      ...
      self.v['$[]='](f00, self.v['$[]'](f00)['$-'](self.v['$[]'](f0)));}else if ((6)['$===']($case)) {self.v['$[]='](15, (self.v['$[]'](f00)['$&'](1)))}else if ((14)['$===']($case)) {self.v['$[]='](15, ((self.v['$[]'](f00)['$&'](57344))['$>>'](15)))}}else if ((1)['$===']($case) || (2)['$===']($case)) {self.$puts("jump " + (f000) + " to " + (fff) + " from " + (self.pc));
      if (($a = (f000['$=='](2))) !== false && $a !== nil) {
