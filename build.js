...
(function($opal) {
  ...
  $opal.add_stubs(['$print', '$+', '$[]', '$*', '$==', '$read_nonblock', '$to_i', '$getc', '$include', '$/', '$new', '$map', '$zip', '$update', '$draw_box_s', '$attr_accessor', '$each', '$is_a?', '$index', '$key', '$eq', '$eq=', '$block', '$nil?', '$size', '$sleep', '$unqueue', '$on_unblock', '$call', '$const_get', '$collect', '$-', '$to_proc', '$chars', '$concat', '$ready', '$pause', '$run', '$pause=', '$run_multiple', '$run_instruction', '$>', '$now', '$beep', '$>>', '$&', '$get_current_key', '$[]=', '$each_with_index', '$%', '$push', '$^', '$write', '$delete_at', '$times', '$pop', '$===', '$send', '$include?', '$rand', '$draw', '$key_pressed', '$instance_variable_set', '$split', '$sprintf']);
  (function($base, $super) {
    function $Terminal(){};
...
if (a == null) a = nil;
  ...
  return (function($base, $super) {
    ...
    def.width = def.height = def.mem = def.pc = def.t = def.DT = def.ST = def.out = def.i = def.v = def['in'] = def.I = def.stack = nil;
...
if (dx == null) dx = nil;
    ...
    return (def.$run_instruction = function(i) {
      var $a, $b, TMP_9, $c, $d, TMP_11, TMP_12, $e, TMP_13, $f, TMP_14, self = this, f000 = nil, f00 = nil, f0 = nil, f = nil, ff = nil, fff = nil, $case = nil, a = nil;
...
if (y == null) y = nil;
      ...
      return false;}else if ((3)['$===']($case) || (5)['$===']($case)) {if (self.v['$[]'](f00)['$=='](((function() {if (($a = [3, 4]['$include?'](f000)) !== false && $a !== nil) {
        ...
        self.pc = self.pc['$+'](2)}}else if ((5)['$===']($case) || (9)['$===']($case)) {if (($a = ($c = self.v['$[]'](f00)['$=='](((function() {if (($d = [3, 4]['$include?'](f000)) !== false && $d !== nil) {
        return ff
        } else {
        return self.v['$[]'](f0)
...
if (e == null) e = nil;
      self.v['$[]='](f00, e);
        return self.ready = true;}, TMP_11._s = self, TMP_11), $a).call($c));}else if ((21)['$===']($case) || (24)['$===']($case)) {self.$instance_variable_set("@" + ((function() {if (ff['$=='](24)) {
        return "S"
        } else {
        return "D"
      }; return nil; })()) + "T", self.v['$[]'](f00))}else if ((41)['$===']($case)) {self.I = self.v['$[]'](f00)['$*'](5)}else if ((7)['$===']($case)) {self.v['$[]='](f00, self.DT)}else if ((51)['$===']($case)) {($a = ($d = self.$sprintf("%03d", self.v['$[]'](f00)).$split("")).$each_with_index, $a._p = (TMP_12 = function(v, x){var self = TMP_12._s || this;
        if (self.mem == null) self.mem = nil;
        if (self.I == null) self.I = nil;
if (v == null) v = nil;if (x == null) x = nil;
      return self.mem['$[]='](self.I['$+'](x), v)}, TMP_12._s = self, TMP_12), $a).call($d)}else if ((85)['$===']($case)) {($a = ($e = ($range(0, f00, false))).$each, $a._p = (TMP_13 = function(x){var self = TMP_13._s || this;
        if (self.mem == null) self.mem = nil;
        if (self.I == null) self.I = nil;
        if (self.v == null) self.v = nil;
if (x == null) x = nil;
      return self.mem['$[]='](x['$+'](self.I), self.v['$[]'](x))}, TMP_13._s = self, TMP_13), $a).call($e)}else if ((101)['$===']($case)) {($a = ($f = ($range(0, f00, false))).$each, $a._p = (TMP_14 = function(x){var self = TMP_14._s || this;
        if (self.v == null) self.v = nil;
        if (self.mem == null) self.mem = nil;
        if (self.I == null) self.I = nil;
if (x == null) x = nil;
