...
if (dx == null) dx = nil;
    ...
    return (def.$run_instruction = function(i) {
      ...
      if (($a = self.$log()) !== false && $a !== nil) {
        self.$printf("run pc=%d; i=%04x; v=[%s]; I=%d\n", ((self.pc['$-'](512))['$/'](2)), self.i, self.v.$join(", "), self.I)};
