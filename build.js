...
(function($opal) {
  ...
  $opal.add_stubs(['$print', '$+', '$[]', '$*', '$==', '$read_nonblock', '$to_i', '$getc', '$include', '$/', '$new', '$map', '$zip', '$update', '$draw_box_s', '$attr_accessor', '$each', '$is_a?', '$index', '$key', '$eq', '$eq=', '$block', '$nil?', '$size', '$sleep', '$unqueue', '$on_unblock', '$call', '$const_get', '$collect', '$-', '$to_proc', '$chars', '$concat', '$times', '$ready', '$pause', '$step', '$run', '$step=', '$pause=', '$iterations=', '$log=', '$run_multiple', '$run_instruction', '$>', '$now', '$beep', '$>>', '$&', '$get_current_key', '$[]=', '$each_with_index', '$%', '$push', '$^', '$log', '$puts', '$join', '$write', '$delete_at', '$sprintf', '$parse_instruction_simple', '$printf', '$pop', '$===', '$|', '$include?', '$rand', '$draw', '$key_pressed', '$split']);
  (function($base, $super) {
    function $Terminal(){};
