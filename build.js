...
(function($opal) {
  ...
  $opal.add_stubs(['$collect', '$gsub', '$[]', '$to_proc', '$to_a', '$is_a?', '$each', '$parse_line', '$include?', '$split', '$parse_instruction', '$scan', '$join', '$upcase', '$match', '$new', '$to_s', '$start_with?', '$<<', '$sprintf', '$map', '$to_i', '$keys', '$assemble', '$collect!', '$=~', '$>', '$size', '$==', '$[]=', '$first', '$compact', '$nil?', '$last', '$+']);
  return (function($base, $super) {
    function $Assembler(){};
    ...
    def.$parse_instruction = function(i) {try {
...
if (re == null) re = nil;
      if (($a = ($b = ($c = (m = i.$match((($d = $scope.Regexp) == null ? $opal.cm('Regexp') : $d).$new(re))), ($c === nil || $c === false)), ($b === nil || $b === false))) !== false && $a !== nil) {
          ...
          self.text['$<<'](($a = self).$sprintf.apply($a, [ins.$to_s().$gsub("(\\d+)", "%d").$gsub("(\\w+)", "%d")].concat((($b = ($c = m.$to_a()['$[]']($range(1, -1, false))).$map, $b._p = (TMP_7 = function(x){var self = TMP_7._s || this;if (x == null) x = nil;
          return x.$to_i(16)}, TMP_7._s = self, TMP_7), $b).call($c)))));
          $opal.$return(nil);
          } else {
          return nil
        }}, TMP_6._s = self, TMP_6), $a).call($b);
      return self.text['$<<'](self.$sprintf(".data %d", i.$to_i(16)));
      } catch ($returner) { if ($returner === $opal.returner) { return $returner.$v } throw $returner; }
    };
...
if (p == null) p = nil;
    ...
    return (def.$parse_line = function(line) {
      ...
      if (line.$size()['$>'](0)) {
        ...
        r = ($a = ($c = self.instructions.$keys()).$map, $a._p = (TMP_11 = function(re){var self = TMP_11._s || this, $a;if (re == null) re = nil;
...
if (y == null) y = nil;
      ...
      return false;}else if ((12)['$===']($case)) {self.v['$[]='](f00, self.$rand(255)['$&'](ff))}else if ((10)['$===']($case)) {self.I = fff}else if ((13)['$===']($case)) {self.$draw()}else if ((14)['$===']($case)) {if (($a = [161, 158]['$include?'](ff)) !== false && $a !== nil) {
...
if (v == null) v = nil;if (x == null) x = nil;
      return self.mem['$[]='](self.I['$+'](x), v)}, TMP_12._s = self, TMP_12), $a).call($d)}else if ((85)['$===']($case)) {($a = ($e = f00.$times().$to_a()).$each, $a._p = (TMP_13 = function(x){var self = TMP_13._s || this;
        if (self.mem == null) self.mem = nil;
        if (self.I == null) self.I = nil;
        if (self.v == null) self.v = nil;
if (x == null) x = nil;
      return self.mem['$[]='](x['$+'](self.I), self.v['$[]'](x))}, TMP_13._s = self, TMP_13), $a).call($e)}else if ((101)['$===']($case)) {($a = ($f = f00.$times().$to_a()).$each, $a._p = (TMP_14 = function(x){var self = TMP_14._s || this;
        if (self.v == null) self.v = nil;
        if (self.mem == null) self.mem = nil;
        if (self.I == null) self.I = nil;
if (x == null) x = nil;
...
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;
  $opal.add_stubs(['$output', '$parse', '$new', '$run_multiple', '$unparse', '$map', '$to_i', '$scan', '$join', '$split', '$p']);
  ;
  ;
  ;
  return (function($base, $super) {
