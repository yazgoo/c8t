...
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;
  $opal.add_stubs(['$output', '$parse', '$new', '$p', '$run_multiple', '$map', '$to_i', '$scan', '$join', '$split']);
  ;
  ;
  ;
  return (function($base, $super) {
    ...
    return (def.$run2 = function(text) {
      var $a, $b, TMP_1, self = this, assembly = nil, e = nil;
      assembly = ($a = ($b = text.$split("\n").$join().$scan(/../)).$map, $a._p = (TMP_1 = function(s){var self = TMP_1._s || this;if (s == null) s = nil;
      return s.$to_i(16)}, TMP_1._s = self, TMP_1), $a).call($b);
      self.$p(assembly);
      e = (($a = $scope.Emulator) == null ? $opal.cm('Emulator') : $a).$new(assembly, "Window");
      e.$run_multiple();
      return e;
