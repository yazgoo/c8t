...
(function($opal) {
  ...
  $opal.add_stubs(['$call', '$output', '$parse', '$new', '$run_multiple', '$<<', '$unparse', '$join', '$map', '$sprintf', '$to_i', '$scan', '$split', '$each', '$gsub', '$ord', '$reverse', '$decode', '$parameter', '$[]', '$+', '$encode', '$to_json', '$value', '$minify', '$value=', '$load_program', '$on', '$keys_push', '$key_code', '$/', '$-', '$page_x', '$width', '$target', '$every', '$>', '$focus', '$clear', '$send!', '$errback', '$p', '$callback', '$==', '$append', '$list']);
  ;
  ;
  ;
  ;
